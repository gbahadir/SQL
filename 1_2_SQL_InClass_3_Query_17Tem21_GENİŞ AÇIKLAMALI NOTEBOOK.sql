...
-- Pivot, satýr bazlý analiz sonucunu sütun bazýna dönüþtürülmesini saðlýyor. 
	-- group by gibi bir gruplama yapýyor. dolayýsýyla group by kullanmýyoruz, pivota özel bir syntax kullanýyoruz
	-- bu syntax içerisinde aggregate iþlemi yapýp ilgili sütunlardaki kategorilere göre bir pivot table oluþturuyor.
	-- ve o sütunun satýrlarýný oluþturan her bir kategoriyi birer sütuna dönüþtürüyor. 
	-- yani satýrlardaki value'lar sütunlarda sergileniyor
...
-- pivot tablonun sütun isimlerini almak için aþaðýdaki iki query de kullanýlabilir:
...
ORDER BY 1  -- bir de order by ekleyelim güzel gözüksün.
	/* þimdi bir kýrýlma daha bir boyut daha eklemiþ olduk. önceden sadece
kategorilere göre ayýrým yapýyordu þimdi ise kategorilerin içinde 
model yýllara göre de ayýrým yaptýk.*/
